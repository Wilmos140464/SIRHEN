...
###
{
        ...
        ## Verification de la presence du fichier tmstmp_tr18_extr_aaf_ok. S'il n'y est pas, on le cree en y ajoutant un timestamp.

	Command="date +'%Y-%m-%d-%H.%M.%S.000000' > $fic_tmstmp_tr18_extr_aaf_ok; chmod 664 $fic_tmstmp_tr18_extr_aaf_ok"
        eval ${Command}
        TEST_ERROR ${?} "Impossible de creer le temoin aaf"
...
### objet: Lancement du scenario
	...
	MESSAGE "### $FUNCNAME Lancement du scenario ${UXARCHIVE} ### "
